<%-- 
    Document   : index2
    Created on : Oct 15, 2016, 3:20:02 PM
    Author     : TAIBAPHI
--%>
...
//                                            out.print("</form>");
                                    ...
                                    <!--<form action="ControllerCartBean">-->
                                        <li>
                                            <a href="blog.html"><img src="<%= sp.getImage()%>" width="65" height="65" alt=""></a>
                                            <h1><%= sp.getName()%></h1>
                                            <h1><%= sp.getPrice()%></h1>
                                            <span>Code: <%= sp.getCode()%></span>
                                            <a href="ControllerCartBean?action=Add to Cart&txtCode=<%= sp.getCode()%>&txtName=<%= sp.getName()%>&txtPrice=<%= sp.getPrice()%>" class="more">Add to cart</a>
                                        </li>
                                    <!--</form>-->
                                    <%
                                        }
